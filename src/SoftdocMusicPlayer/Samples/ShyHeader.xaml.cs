...
//using static ExpressionBuilder.CompositionExtensions;
...
namespace SoftdocMusicPlayer
{
    ...
    /// </summary>
    public sealed partial class ShyHeader : Page
    {
        ...
        private void SamplePage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var scrollBar = gridView.ChildrenBreadthFirst().OfType<ScrollBar>().First();
            if (scrollBar != null)
            {
            ...
            ExpressionNode blurAnimation = EF.Lerp(0, 25, progressNode);

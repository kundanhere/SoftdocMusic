...
{
    public sealed partial class ShadowsAdvanced : Page
    {
        private const int _rows = 2;
        private const int _columns = 6;
        private const int _itemLength = 160;
        private const int _gridMargin = 100;
        private const int _itemMargin = 10;
        private const float _initialShadowBlurRadius = 15.0f;
        private const float _initialShadowOpacity = 0.5f;
        private int _shadowHighestZ = 2;
        private int _contentHighestZ = 3;

...
namespace SoftdocMusicPlayer.Samples.LightInterop

{
    internal class MaterialBrush : XamlCompositionBrushBase
    {
        ...
        protected override void OnConnected()
        {
            ...
            _surface = LoadedImageSurface.StartLoadFromUri(new Uri("ms-appx:///Assets/Bubblenm.jpg"), new Size(400, 400));

    ...
    public class UserDataService
    {
        ...
        private async Task<UserViewModel> GetUserViewModelFromData(User userData)
        {
            ...
            var userPhoto = string.IsNullOrEmpty(userData.Photo)
                ? ImageHelper.GetImageFromAssetsFile("DefaultIcon.png")
                : await ImageHelper.GetImageFromStringAsync(userData.Photo);
        ...
        private UserViewModel GetDefaultUserData()
        {
            return new UserViewModel()
            {
                ...
                Photo = ImageHelper.GetImageFromAssetsFile("DefaultIcon.png")
            };
        }
    }
}
